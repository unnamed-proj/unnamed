...
<!--      <img src="https://www.floatui.com/logo.svg" class="w-32 sm:mx-auto" />-->
      <p v-if="false" class="leading-relaxed my-4 text-[15px]">
        Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a
        galley of type and scrambled it to make a type specimen book.
      </p>
      <div class="text-black flex flex-col sm:flex-row sm:items-center mt-4 justify-start gap-5 overflow-hidden w-full">
        <n-avatar
            :size="48"
    ...
    <ul v-if="false" class="items-center justify-center mt-2 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
